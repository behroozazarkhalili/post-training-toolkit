...
class DiagnosticsCallback(TrainerCallback):
    ...
    def __init__(
        ...
        snapshot_prompts: Optional[List[str]] = None,
        ...
        fail_on_resume_mismatch: bool = False,
        ...
        self.snapshot_prompts = snapshot_prompts
